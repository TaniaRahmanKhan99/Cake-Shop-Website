    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">Cookies</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">Our selection is packed with miles of flavor in each bite and drop-what-you’re-doing-and-eat-a-cookie worthy!
            </h4>
            ...
            <div class="row text-center">
              ...
              <?php
                ...
                $query = "select * from cookies order by prod_id asc";

...
<html>
    <head>
        <title>Delicious Gift Box and PartY Cakes</title>
        <meta charset = "UTF-8">
    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">Sweet Bundles</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">The sweetest bundles are the ones you can eat! Whether you are for a looking for a birthday gift, to say thank you, an afternoon sweet treat spread with friends and family or an office or dinner party bundle, we’ve got something for every occasion selection of pocket sized three-layered naked cakes filled with layers of luscious frosting designed especially for you. 
            </h4>
            ...
            <div class="row text-center">
              ...
              <?php
                ...
                $query = "select * from sweetbundle order by prod_id asc";

...
<html>
    <head>
        <title>Unique Vegan and Healthy Cakes & Desserts</title>
        <meta charset = "UTF-8">
    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">Vegan Desserts</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">An irresistible selection of pocket sized three-layered naked cakes filled with layers of luscious frosting designed especially for you. 
            </h4>
            ...
            <div class="row text-center">
              ...
              <?php
                ...
                $query = "select * from vegandesserts order by prod_id asc";

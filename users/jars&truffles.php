    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">Jars & Truffles</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">A delicious selection of cheeky-guilty-pleasures that will satisfy a gentle sweet craving at any time of day. These treats vary from bite-sized truffles to layered desserts in jars.
            </h4>
            ...
            <div class="row text-center">
              ...
              <?php
                ...
                $query = "select * from jars_and_truffles order by prod_id asc";

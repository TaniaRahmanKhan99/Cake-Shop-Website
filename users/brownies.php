    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">Brownies</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">Our crowd-pleasing selection of brownies are fudgy and sweet. Whether you are looking for the classic gooey chocolate slice or one with a twist, our selection will definitely have you coming back for more
            </h4>
            ...
            <div class="row text-center">
              ...
              <?php
                ...
                $query = "select * from brownies order by prod_id asc";

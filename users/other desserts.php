    ...
    <body>
      ...
      <div id="preloader"></div>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container text-center">
            <h1 style="font-family: cursive; color: palevioletred; padding-top: 90px;">&OTHERDESSERTS</h1>
            <br>
            <h4 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">Our new dessert line will have several dessert lines! Our first is cheesecake, get ready to crack into our delicious baked crusts for a cheesecake like no other! We guarantee our recipe is unlike anything you have experienced before…! 
            </h4>

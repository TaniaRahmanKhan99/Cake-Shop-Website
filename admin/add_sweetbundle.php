...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$description = $_POST['description'];
	 ...
	 $upload_photo =  "sweetbundle/". $unique_name;
	 ...
	 if($photo_size > 1048576){
		 ...
		 $sql = "insert into sweetbundle(prod_name, prod_price, h_name, h_price, prod_description, prod_image) values ('$name', '$price', '$h_name', '$h_price', '$description', '$upload_photo')";
		 ...
		 if($result){
			 echo "<script>
			  ...
			  window.location.href = 'manage_sweetbundle.php';
			  </script>";
		 }else{
			 echo "<script>
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-8 text-center" >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; ">Add Sweet Bundle</b></h2>
                <br>

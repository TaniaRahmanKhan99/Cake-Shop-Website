...
if(isset($_GET['deleteID'])){
    ...
    $isql = "select * from product where prod_id = '$did'";
    ...
    $del_sql = "delete from product where prod_id = '$did'";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">OTHERDESSERTS</b></h2>

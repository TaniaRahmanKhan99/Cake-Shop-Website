...
if(isset($_GET['deleteID'])){
    ...
    $isql = "select * from cupcake where prod_id = '$did'";
    ...
    $del_sql = "delete from cupcake where prod_id = '$did'";
    
    $del = $db->delete($del_sql);
    
    if($del){
        header("location: manage_cupcakes.php");
    }else{
        echo "<script>
        alert('Delete Failed!!');
        </script>";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-2 text-center" id="navDiv">
                ...
                <h4 id="title" style="width: 200px; margin-bottom: 0; font-family: cursive">Add New Employee</h4>
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Cup Cakes</b></h2>
               

                <div class="card shadow">

                    <a href="add_cupcakes.php" class="btn btn-success">Add New Product</a>
                    <br>
                    <br>
<!--
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 style="margin-left: -450px; color: palevioletred;">All EmployeeS</h3>
    ...
    -->
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
							...
							$query = "select * from cupcake order by prod_id desc";
							...
							<tr>
                                ...
                                <td><img src="<?=$row['prod_image'];?>" style="width:100px; height=100px;"></td>
								<td><?=$row['prod_id'];?></td>
								<td><?=$row['prod_name'];?></td>
								...
								<td>
									<a href="?deleteID=<?=$row['prod_id'];?>" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger">Delete</a>
								</td>

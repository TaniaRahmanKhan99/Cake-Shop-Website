    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-8 text-center" >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; ">Add Admin</b></h2>
                <br>
                <br>
                <br>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <input class="a btn btn-success " style="color:white; background-color:#ff99bb" type="submit" name="submit" value=" ADD ADMIN " >
                    <br>
                    <br>

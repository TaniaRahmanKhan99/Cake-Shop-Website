...
if(isset($_GET['deleteID'])){
    ...
    $isql = "select * from brownies where prod_id = '$did'";
    ...
    $del_sql = "delete from brownies where prod_id = '$did'";
    
    $del = $db->delete($del_sql);
    
    if($del){
        header("location: manage_brownies.php");
    }else{
        echo "<script>
        alert('Delete Failed!!');
        </script>";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Brownies</b></h2>
               

                <div class="card shadow">

                    <a href="add_brownies.php" class="btn btn-success">Add New Product</a>
                    <br>
                    <br>
<!--
    ...
    -->
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
							...
							$query = "select * from brownies order by prod_id desc";

...
if(isset($_GET['deleteID'])){
    ...
    $del_sql = "delete from user where u_id = '$dId'";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Users Who Signed IN</b></h2>
                <br>
                <br>
                <br>
...
-->
                ...
                <tr>
                    ...
                    <td>
                        <a href="?deleteID=<?=$row['u_id']?>" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger">Delete</a>
                    </td>

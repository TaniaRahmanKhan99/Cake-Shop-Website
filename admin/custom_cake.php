...
if(isset($_GET['deleteID'])){
    ...
    $del_sql = "delete from create_cake where id = '$dId'";
    $del = $db->delete($del_sql);
    
    
    if($del){
        header("location: custom_cake.php");
    }else{
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Custom Cake Orders</b></h2>
                <br>
                <br>
                <br>
...
-->
                ...
                $sql = "select * from create_cake order by id desc";

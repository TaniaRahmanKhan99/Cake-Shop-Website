...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$position = $_POST['position'];
	 ...
	 $upload_photo =  "../upload/employee/". $unique_name;
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-8 text-center" >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; ">Add Employee</b></h2>
                <br>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <label>Address</label>
                    <textarea name="address" class="form-control" id="address" placeholder="Your Address"></textarea>

                    <label>Position</label>
                    <input type="text" name="position" id="position" placeholder="Enter your Position" class="form-control" required>
                    ...
                    <input class="a btn btn-success " style="color:white; background-color:#ff99bb" type="submit" name="submit" value=" ADD Employee " >
                    <br>
                    <br>

...
if(isset($_GET['deleteID'])){
    ...
    $isql = "select * from icecream where prod_id = '$did'";
    ...
    $del_sql = "delete from icecream where prod_id = '$did'";
    
    $del = $db->delete($del_sql);
    
    if($del){
        header("location: manage_icecream.php");
    }else{
        echo "<script>
        alert('Delete Failed!!');
        </script>";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Ice Cream</b></h2>
               

                <div class="card shadow">

                    <a href="add_icecream.php" class="btn btn-success">Add New Product</a>
                    <br>
                    <br>
<!--

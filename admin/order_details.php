...
if(isset($_GET['deleteID'])){
    ...
    $del_sql = "delete from user_orders where id = '$dId'";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-6 " style="margin-left:200px" >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 300px; ">Order Details</b></h2>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 style="margin-left: -450px; color: palevioletred;"></h3>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
							...
							$sql = "select * from user_orders order by id desc";
							...
							<tr>
								...
								<td><?=$row['price']?></td>                  
                                <td><?=$row['Quantity']?></td>                 
								<td><a href="customer_order.php" class="btn" style="background-color:#9966ff; color:white;">Back to Customer Order</a></td>
                                <td>

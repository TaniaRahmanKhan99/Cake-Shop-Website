...
if(isset($_GET['deleteID'])){
    ...
    $isql = "select * from sweetbundle where prod_id = '$did'";
    ...
    $del_sql = "delete from sweetbundle where prod_id = '$did'";
    
    $del = $db->delete($del_sql);
    
    if($del){
        header("location: manage_sweetbundle.php");
    }else{
        echo "<script>
        alert('Delete Failed!!');
        </script>";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Sweet Bundles</b></h2>
               

                <div class="card shadow">

                    <a href="add_sweetbundle.php" class="btn btn-success">Add New Product</a>
                    <br>
                    <br>
<!--
    ...
    -->
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
							...
							$query = "select * from sweetbundle order by prod_id desc";

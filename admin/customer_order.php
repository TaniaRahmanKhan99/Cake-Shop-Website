...
if(isset($_GET['deleteID'])){
    ...
    $del_sql = "delete from order_manager where id = '$dId'";
    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-9 " >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; margin-left: 500px; ">Customer Orders</b></h2>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
							...
							$sql = "select * from order_manager order by id desc";
							...
							<tr>
								...
								<td><?=$row['address']?></td>
								<td><?=$row['payment']?></td>                  
								<td><a href="order_details.php" class="btn btn-info">Show Deatils</a></td>
								<td>

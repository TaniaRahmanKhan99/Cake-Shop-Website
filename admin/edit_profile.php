    ...
    <div class="container-fluid" style="height:80%; padding:0;">
        ...
        <div class="row" style="height:100%;">
            ...
            <div class="col-md-8 text-center" >
                ...
                <h2><b style="font-family: cursive; color: palevioletred; ">Edit Profile</b></h2>
                <br>
                <br>
                <br>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <label>Name</label>
                    <input type="text" name="name" id="name" placeholder="Enter your Name" class="form-control" value="<?php echo $row['name']; ?>">

                    <label>Email</label>
                    <input type="email" name="email" id="email" placeholder="Enter your Email" readonly class="form-control" value="<?php echo $row['email']; ?>">
                    
                    <label>Phone</label>
                    <input type="text" name="phone" id="phone" placeholder="Enter your Phone Number" class="form-control" value="<?php echo $row['phone']; ?>">
                    
                 
                    <label>Address</label>
                    <textarea name="address" class="form-control" id="address" placeholder="Your Address" value="<?php echo $row['address']; ?>"></textarea>
                    ...
                    <input class="a btn btn-success " style="color:white; background-color:#ff99bb" type="submit" name="submit" value="Update" >
                    <br>
                    <br>
